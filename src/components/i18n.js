export const translations = {
  ...
  fa: {
    ...
    contact: {
      badge: "تماس",
      title: "از ایـــــده شمــــــا تا رشـــــد کســــب و کار شما",
      description:
        "اگر برای طراحی سایت، داشبورد، لندینگ پیج، اپلیکیشن React، سیستم اتوماسیون فروشگاهی یا پنل‌های مدیریتی اختصاصی نیاز به همکاری داری، چند خط درباره پروژه‌ات بنویس. فرم زیر متن ایمیل را آماده می‌کند تا راحت از Gmail ارسالش کنی.",
      email: "ایمیل",
      linkedin: "LinkedIn",
      copyEmail: "کپی ایمیل",
      copyEmailDescription: "برای تماس دستی، ایمیل را سریع کپی کن",
      formBadge: "Project Brief",
      formTitle: "بــــه من بگو که قــــراره چه مسیـــری رو شــروع کــنــیــم",
